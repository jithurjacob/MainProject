 ...
 <div class="top">
          ...
          <div class="col-xs-12">
            ...
            <div class="row">            
              <div class="form-group col-xs-6">
                ...
                <input class="form-control form-control_white" id="name2" name="name" onblur="if(this.value == '') this.value='Name'" onfocus="if(this.value == 'Name') this.value=''" type="text" value="Name">
                <div class="error" id="err-name">Please enter name</div>
              </div>
              <div class="form-group col-xs-6">
                <label for="email2">email</label>
                <input  class="form-control form-control_white" id="email2" name="email"  type="text"  onfocus="if(this.value == 'E-mail') this.value='';" onblur="if(this.value == '') this.value='E-mail';" value="E-mail">
            ...
            <div class="row">            
              <div class="form-group col-xs-12">
                ...
                <textarea  class="form-control form-control_white" id="message2" name="message" onblur="if(this.value == '') this.value='Message'" onfocus="if(this.value == 'Message') this.value=''">Message</textarea>
    ...
    <div style="background-color: rgb(57, 58, 71);height: 150px"> </div>
  </footer> <!-- Footer ends -->
