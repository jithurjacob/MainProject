...
public class SequoroOAuth_Reg {
    ...
    public SequoroOAuth_Reg() throws UnsupportedEncodingException, IOException {
        String baseurl="http://localhost:8080/site/";//"http://sequoro1.jelasticlw.com.br/";//
        clientId = "tOYj7kSbXo6MTf/8ZuSmvZaeaDc="; // provide your client id
        clientSecretKey = "MzU0NTkxOTMzdGVzdDFAZ21haWwuY29tZGVtb2h0dHA="; // provide your secre key
        redirectUrl = "http://localhost:8080/demo/reg.jsp";//provide your redirect url
