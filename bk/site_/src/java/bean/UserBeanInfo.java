...
public class UserBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_keydetails = 1;
    private static final int PROPERTY_keyhash = 2;
    private static final int PROPERTY_pasw = 3;
    private static final int PROPERTY_protocol = 4;
    private static final int PROPERTY_public_key = 5;
    private static final int PROPERTY_secondary_password = 6;
