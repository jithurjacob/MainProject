...
$("#help_link_siteowner").click(function(){
      window.location=("./siteowner/help.jsp");
  // window.open("./login_page.jsp");
});
  ...
  // window.open("./login_page.jsp");
     ...
     $("#changepwd_link").click(function(){
      window.location=("./users_pages/changepwd.jsp");
  // window.open("./login_page.jsp");
});
 $("#changepwd_link_siteowner").click(function(){
      window.location=("./siteowner/changepwd.jsp");
  // window.open("./login_page.jsp");
});
     $("#dash_link").click(function(){
      window.location=("./users_pages/dashboard.jsp");
  // window.open("./login_page.jsp");
}); 
$("#dash_link_siteowner").click(function(){
      window.location=("./siteowner/dashboard.jsp");
  // window.open("./login_page.jsp");
});
 $("#websites_link_siteowner").click(function(){
      window.location=("./siteowner/websites.jsp");
  // window.open("./login_page.jsp");
});
     $("#securitylevel_link").click(function(){
      window.location=("./users_pages/securitylevel_page.jsp");
  // window.open("./login_page.jsp");
});
   $("#securitylevel_link_siteowner").click(function(){
      window.location=("./siteowner/securitylevel_page.jsp");
  // window.open("./login_page.jsp");
});
