...
public class SequoroOAuth {
    ...
    public SequoroOAuth() throws UnsupportedEncodingException, IOException {
        ...
        clientId = "7fbISW4q1gNIKkM3roUSOYsMV2A="; // provide your client id
        clientSecretKey = "MTE1MTUxNTl0ZXN0MUBnbWFpbC5jb21kZW1vIGxvZ2k="; // provide your secre key
        redirectUrl = "http://localhost:8080/demo/login.jsp";//provide your redirect url
