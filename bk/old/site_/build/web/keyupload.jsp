...
<%
  String key=null,hash=null;
    String email=null;// = request.getParameter("email").toString();
%> 
...
//out.println("key : "+a.getParameter("key"));
    try {
        String fileName = d.getAbsolutePath() + "/keys/" + a.getParameter("email").toString() + (Math.random() * 10000) + ".key";
...
<jsp:setProperty name="obj" property="public_key" value="<%= key %>" />  
