    ...
    <body class="bg api">
        <section id="demo" style="padding: 10px">
            <div class="container">
                ...
                <%
               // System.out.print(website_obj.isValidRequest()+""+valid+""+verifyNonce()+api_obj.isValidState(state));
                   try{
                if (website_obj.isValidRequest() && valid && verifyNonce(con_obj.baseurl) && api_obj.isValidState(state)) {
