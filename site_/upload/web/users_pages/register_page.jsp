    ...
    <body class="bg">
        ...
        <section id="demo">
            <div class="container">
               ...
               <h3 class="text-left">User Registration</h3>
                <div class="row spacer20"></div> 
                <p>Please register to access Sequoro services.If you are a Website owner trying to include Sequoro login to your websites<a href="siteowner/register_page.jsp"> click here</a></p>
                ...
                <form id="demo_form" method="POST" role="form" action="javascript:register();" class="form-horizontal form-main">
                    ...
                    <div class="form-group">
                        ...
                        <input required=""  class="form-control disabled" id="name_txt" name="name_txt" placeholder="Enter name">
                    </div>
                    <div class="form-group">
