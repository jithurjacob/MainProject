...
public class OtpBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_accesscode = 0;
    private static final int PROPERTY_client_id = 1;
    private static final int PROPERTY_email = 2;
    private static final int PROPERTY_id = 3;
    private static final int PROPERTY_otp_hash = 4;
    private static final int PROPERTY_secure_otp_hash_id = 5;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accesscode] = new PropertyDescriptor ( "accesscode", bean.Otp.class, "getAccesscode", "setAccesscode" ); // NOI18N
            properties[PROPERTY_client_id] = new PropertyDescriptor ( "client_id", bean.Otp.class, "getClient_id", "setClient_id" ); // NOI18N
